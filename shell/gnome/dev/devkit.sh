...
usage() {
    ...
    echo "  SCENARIO=full|showcase|showcase-update|combined|providers|several|several-auto|icon|collapsed|live|incident|onboarding|critical|empty|spend-only|offline|single|no_subscription|accounts  sample state" >&2
