...
usage() {
    ...
    echo "  SCENARIO=full|showcase|showcase-update|combined|providers|several|several-auto|icon|collapsed|live|incident|onboarding|critical|empty|offline|single|no_subscription  sample state" >&2
