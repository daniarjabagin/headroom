...
usage() {
    ...
    echo "  SCENARIO=full|showcase|showcase-update|critical|empty|offline|single|no_subscription  sample state served by the mock daemon" >&2
