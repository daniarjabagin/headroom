...
function collapsedView(ctx, cards, onToggle) {
...
export function collapsedRow(ctx, cards, expanded, onToggle) {
    return expanded ? expandedView(onToggle) : collapsedView(ctx, cards, onToggle);
}
