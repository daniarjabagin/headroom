...
import { testAccountsModel } from './accountsModelTests.js';
import { testCollapsedAttention } from './collapsedAttentionTests.js';
...
import { testHeaderMarks } from './headerMarkTests.js';
...
import { testRenderChurn, testSectionPlan } from './renderChurnTests.js';
...
import { testModelBreakdown, testModelShares, testOrder, testProgress } from './shapingTests.js';
...
testHeaderMarks();
testCollapsedAttention();
testRenderChurn(readSample());
testSectionPlan(readSample());
testRenderChurn(readSnapshot('state_combined.json'));
testPrefsModels();
testAccountsModel();
