public enum MeterSheen {
    public static let sweepSeconds = 1.6
    public static let restSeconds = 3.5
    ...
    public static func progress(elapsed: Double) -> Double? {
        ...
        let phase = elapsed.truncatingRemainder(dividingBy: cycleSeconds)
    ...
    public static func nextFrame(after elapsed: Double, frameSeconds: Double = frameSeconds) -> Double {
        ...
        let cycleStart = (elapsed / cycleSeconds).rounded(.down) * cycleSeconds
