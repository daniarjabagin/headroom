...
The logos in this directory come from [Simple Icons](https://simpleicons.org) (CC0-1.0).
`openai.svg` and `claude.svg` were taken from an earlier release; the others from 16.32.0
(`https://cdn.jsdelivr.net/npm/simple-icons@16.32.0/icons/<slug>.svg`). Files are named by their
...
| --- | --- | --- |
| `codex` | `openai.svg` | monochrome, follows the text color |
| `claude` | `claude.svg` | brand color `#D97757` |
| `opencode` | `opencode.svg` | monochrome |
| `openrouter` | `openrouter.svg` | monochrome |
